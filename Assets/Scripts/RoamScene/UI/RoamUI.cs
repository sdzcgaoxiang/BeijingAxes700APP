...
public class RoamUI : UserInterface
{
    ...
    public override void Initialize()
    {
        ...
        m_InterActBtn = UITool.GetUIComponent<Button>(m_RootUI, "InterActBtn");
    }
